            ...
            <div className="top_main_content">
                ...
                <div className="">
                    <div className="flex_wrapper width-60">
                        <div className="content_title list_name">
                            プロジェクト一覧
                        </div>
                        <div className="content_title list_name margin-left-l">
                            作成日
                        </div>
                    </div>

                    <div className="flex_wrapper width-100">
                        <div onClick={onClickProjetShowPage}>
                            作成したプロジェクト名
                        </div>
                        <div>2024/07/15</div>
                        <div className="">
                            {/* 編集ボタン */}
                            <button className="top_edit_delete_btn">
                                編集
                            </button>
                            {/* 削除ボタン */}
                            <button className="top_edit_delete_btn margin-left">
                                削除
                            </button>
                        </div>
                    </div>
